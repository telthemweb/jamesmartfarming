            ...
            <div class="col-lg-12">
                <div id="switchPoint" class="e-panel card">
                    <div class="card-body">
                        ...
                        <div class="py-1">
                            <form action="<?php route('/role/create'); ?>" method="POST">
                                <input type="hidden" name="_crsftoken" value="<?php CSRFToken(); ?>">
                                <div class="form-group">
                                    <div class="rounded">
                                        <input type="text" class="form-control pl-3" name="name" placeholder="Role Name" required="required" id="name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class=" form-div">
                                    <input type="text" class="form-control pl-3" name="description" placeholder="Description" id="description">
                                    </div>
                                </div>
